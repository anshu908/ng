...
$botToken = "7596868971:AAGgYl8r0SI3rpu5PccZ37mCrIml-J68hX8";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@GOAT_NG</code>';
$botu = "𝐁𝐨𝐭 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ↯ @GOAT_NG";
$cofuid = '1212';
$cofuid2 = '1212';
$cofuid3 = '1212';
#FIN DE LA CAPTURA
...
if ($cdata2 == "back") {
    ...
    $videoUrl = "https://t.me/NGH4X_NEW/370";
...
if ($cdata2 == "price") {
  ...
  ";
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => ' 𝙃𝙤𝙢𝙚 🏡 ', 'callback_data' => 'back2'], ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧', 'url' => 'https://t.me/GOAT_NG']]
        ]
    ]);
...
");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/NGH4X_NEW/370"; 
    ...
    $keyboard2 = json_encode([
        'inline_keyboard' => [
                             ...
                             ['text' => '[🜲] 𝙊𝙬𝙣𝙚𝙧 ', 'url' => 'https://t.me/GOAT_NG'],
                             ['text' => ' 𝗟𝗮𝗳𝗮 (𝗚𝗨𝗜𝗔)', 'url' => 'https://t.me/NGYT777GG']
                                              ],
                                       ]
                                                ]);
