...
if (preg_match('/^(\/id|\.id|!info)/', $text)) {
    ...
    $m = "<b>[火] User information %0A╔═════════════════╗%0A•├User[NAME] » @$username%0A•├User[ID] » <code>$userId</code>%0A•├Name[TG] » $firstname%0A•├User[RANK] » <code>$rank</code>%0A╚═════════════════╝%0A•├Dev » <code>@GOAT_NG</code></b>";
